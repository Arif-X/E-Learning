        ...
        <div class="container">
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="/admin/index/siswa">Data Siswa</a></li>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/admin/index/guru/add">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="status" name="status" class="form-control" readonly value="Guru">
                                </div>
                            </div>
                            ...
                            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="/admin/index/guru/update">
                                                @csrf
                                                <div class="form-group row">
                                                    <div class="col-md-3">
                                                        <label for="no_induk" class="text-right">No Induk</label>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a class="btn btn-success" type="button" href="/admin/index/guru/delete/{{ $users->no_induk }}">Ya</a>
                                        </div>
