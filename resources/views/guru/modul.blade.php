...
<head>
    ...
    <title>{{ $mapels->mapel }} Kelas {{ $mapels->kelas }} Semester {{ $mapels->semester }} Pertemuan {{ $mapels->pertemuan_ke }}</title>
    @endforeach
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-content">                    
                        <h5 class="card-title">{{ $mapels->nama }}</h5><br/>
                        {{ $mapels->keterangan }}<br/><br/>
                        Link Modul <i class="ion-android-arrow-dropright-circle"></i> <a href="/{{ $mapels->modul }}">Lihat Modul</a><br/>
                        Link Tugas <i class="ion-android-arrow-dropright-circle"></i> <a href="/{{ $mapels->modul }}">Lihat Tugas</a><br/>
                    </div>
                    <div class="card-read-more">
                        <a class="btn btn-link btn-block" href="/mapel/{{ $mapels->mapel }}/{{ $mapels->kelas }}/{{ $mapels->semester }}/{{ $mapels->pertemuan_ke }}/modul-dan-tugas"><i class="ion-ios-eye-outline"></i> Detail</a>                    
                    </div>
                </div>
            </div>
            @endforeach
